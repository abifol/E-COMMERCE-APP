...
import text1 from "../assets/images/text (1).png";
import text2 from "../assets/images/text (2).png";
import text3 from "../assets/images/text (3).png";
import text4 from "../assets/images/text (4).png";
import text5 from "../assets/images/text (5).png";
import text6 from "../assets/images/text (6).png";
import text7 from "../assets/images/text (7).png";
import text8 from "../assets/images/text (8).png";
import text9 from "../assets/images/text (9).png";
import text10 from "../assets/images/text (10).png";
import text11 from "../assets/images/text (11).png";
const hero = () => {
  return (
    <div>
      <div class="row">
